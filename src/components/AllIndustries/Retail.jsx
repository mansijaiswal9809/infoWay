  ...
  return (
    <div className='all_industries'>
      ...
      <ul>
        ...
        <li>WAP and Mobile Application Development (for example, Store Locator )</li>
      ...
      <p>Our customer-centric approch and our ability to understand your retail business sets us apart from our competitors. </p>
    </div>
  )
}
